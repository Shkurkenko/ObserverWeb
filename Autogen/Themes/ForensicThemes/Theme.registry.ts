...
export const themeRegistry = {
  'ForensicBlue': () => import('/home/ilya/Documents/Projects/PreactViteBundle/Config/Themes/ForensicThemes/WEB/ForensicBlue/config').then(m => m.default || m),
  'ForensicGreen': () => import('/home/ilya/Documents/Projects/PreactViteBundle/Config/Themes/ForensicThemes/WEB/ForensicGreen/config').then(m => m.default || m),
} as const;
