...
export const THEMES_ROOT_DIR = resolve(
  PROJECT_ROOT,
  "Config/Themes/ForensicThemes/WEB"
);
export const THEMES_CSS_DIR = resolve;
export const GEN_THEMES_OUT_DIR = resolve(
  PROJECT_ROOT,
  "Autogen/Themes/ForensicThemes"
);
export const THEMES_JSON_PATH = resolve(
  PROJECT_ROOT,
  "Config/Themes/ForensicThemes/themes.json"
);

export const THEMES_TYPES_OUTPUT_FILE_PATH = join(
  PROJECT_ROOT,
  "Src/Lib/Themes/Themes.types.ts"
);
